...
import { testColumnsConfigSchema } from '../../helpers/Interfaces';
// Utilities Import
import { getListViewXml, validateSiteExists, } from '../../helpers/Utilities';
export default class TableViewerWebPart extends BaseClientSideWebPart {
    ...
    onPropertyPaneJSONChanged(propertyPath, oldValue, newValue) {
