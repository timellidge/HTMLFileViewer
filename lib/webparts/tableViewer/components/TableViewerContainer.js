...
const TableViewerContainer = (props) => {
    ...
    const { displayMode, title, updateProperty, showTitle, showFind, configured, onConfigure, JSONCode, webPartCSS, siteUrl, listId, viewXmlCode, hideErrorEmpty, themeVariant, contentHeight, contextSiteUrl, contextUser, sidePadding, webPartTag, tabBehaviour } = props;
    //=================================================================================================================
    ...
    return (React.createElement("div", { id: webPartTag, className: _containerClass }, !configured ? (React.createElement(React.Fragment, null,
