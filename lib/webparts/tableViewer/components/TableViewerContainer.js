...
class TableViewerContainer extends React.Component {
    ...
    async fetchChoiceOptions(name) {
        try {
            ...
            const field = await sp.web.lists.getById(this.props.listId).fields.getByInternalNameOrTitle(name)();
    ...
    async parseColumns() {
        try {
            ...
            const NewJSON = convertWidthToPx(1000, columnsObject);
    ...
    renderTabs() {
        ...
        return (React.createElement("div", { style: { marginBottom: '10px' } },
            tabs.map(tab => (React.createElement("button", { key: tab, onClick: () => this.handleTabChange(tab), style: {
                    marginRight: '10px',
            ...
            selectedTab && (React.createElement("button", { onClick: () => this.handleTabChange(null), style: {
                    marginRight: '10px',
        ...
        return (React.createElement("div", { id: this.state.webPartTag }, !configured ? (React.createElement(React.Fragment, null,
            React.createElement(TableViewer, null,
                React.createElement(TableViewerHeader, null,
                    ...
                    showFind && (React.createElement(React.Fragment, null,
                        React.createElement(TextField, { placeholder: "Search...", value: this.state.searchQuery, onChange: this.handleSearch, styles: { root: { marginBottom: 20 } } })))),
                React.createElement(TableViewerBody, null,
                    React.createElement(React.Fragment, null, this.renderTabs()),
