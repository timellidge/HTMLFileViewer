                ...
                const updatedItems = this.state.items.map(item => {
                    ...
                    Object.keys(item).forEach((key) => {
                        ...
                        if (ColumnsJSON[key]) {
                            ...
                            if (type === 'number') {
                                value = value = numberFormat(value, format);
                            }
                            else if (type === 'date') {
                                ...
                                value = value && typeof value === 'object' && value.email ? value.email : ' - ';
                            }
    ...
    render() {
        ...
        return (React.createElement("div", { id: this.state.webPartTag, className: styles.tableViewer }, !configured ? (React.createElement(React.Fragment, null,
            React.createElement(TableViewer, null,
                ...
                React.createElement("div", { className: styles.tabBar }, Object.keys(this.state.tabData).map((field) => (React.createElement(TabBarRender, { key: field, fieldName: field, tabs: this.state.tabData[field], handleTabChange: this.handleTabChange })))),
                React.createElement(TableGridRender, { colJSON: this.state.ColumnsJSON, items: updatedItems })),
