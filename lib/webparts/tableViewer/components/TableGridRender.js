...
const TableGridRender = ({ listUrl, colJSON, items, contentHeight, maxBarValues }) => {
    ...
    const renderBar = (value, name, column) => {
        ...
        return (React.createElement("div", { className: _barCellStyle },
            column.prefix ? React.createElement("span", null, column.prefix) : React.createElement("span", null, "\u00A0"),
            React.createElement("div", { className: _barStyle, title: value },
                React.createElement("div", { className: _barLabelStyle },
                    " ",
                    rawValue,
                    " ")),
            column.suffix ? React.createElement("span", null, column.suffix) : React.createElement("span", null, "\u00A0")));
    };
