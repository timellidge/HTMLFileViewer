...
const TableGridRender = ({ listUrl, colJSON, items, contentHeight, maxBarValues, height }) => {
    ...
    const renderBar = (value, name, column) => {
        ...
        return (React.createElement("div", { className: styles.barGrid },
            ...
            React.createElement("div", { className: _barStyle, title: value }, iconName ? (React.createElement(Icon, { iconName: iconName, title: rawValue.toString(), style: { color: iconColor } })) : (React.createElement("span", null, "\u00A0"))),
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Panel, { isOpen: isSidePanelOpen, onDismiss: closeSidePanel, closeButtonAriaLabel: "Close", type: PanelType.largeFixed },
            React.createElement("iframe", { id: "iframePanel", src: iframeUrl, ref: iframeRef, onLoad: onLoad, style: { border: 'none', height: height + 'px', width: '100%' } }))));
};
