...
const TableGridRender = ({ colJSON, items }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: _GridStyle }, _sortedColumns.map(({ key, column }) => (React.createElement("div", { key: key, className: styles.tableHeaderCell }, column.name)))),
